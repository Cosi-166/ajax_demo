...
// Events can be triggered in all kinds of situations: clicking, page loaded, input field changed,
// mouse hover, mouse up and down, keystroke etc etc. 
...
// Now, let's access the DOM nodes more surgically. There is a complete set of indexing, modifying and searching
// primitives that can choose any part of the dom tree. 
